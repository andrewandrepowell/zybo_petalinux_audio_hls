...
extern "C"
{
	...
	static inline __attribute__ ( ( always_inline ) )
	void audio_write_mem_reset_txrx( audio* ptr )
	{
		audio_write_mem( ptr, AUDIO_REG_I2S_RESET, 0b110 ); /* Reset TX and RX Fifos. */
		audio_write_mem( ptr, AUDIO_REG_I2S_CTRL, 0b011 ); /* Enable TX and RX Fifos and disable MUTEEN. */
	}
